...
image::acm-multicluster-2-7/RHACM_all_cluster.png[]
...
image::acm-multicluster-2-7/credentials.png[]

image::acm-multicluster-2-7/add_cred.png[]

=== You will need to provide connection details:

* Cloud Provider Credentials: Choose *Amazon Web Services* +

image::acm-multicluster-2-7/aws_cred.png[]

image::acm-multicluster-2-7/aws_cred2.png[]
...
image::acm-multicluster-2-7/cred_basicinfo.png[]
...
image::acm-multicluster-2-7/screen2.png[]
...
image::acm-multicluster-2-7/pull_secret.png[]
...
image::acm-multicluster-2-7/screen4.png[]
...
image::acm-multicluster-2-7/create_cluster.png[]


[start=3]
3. Select *Amazon Web services*

image::acm-multicluster-2-7/aws_cluster.png[]

[start=4]
4. Select *Standalone*

image::acm-multicluster-2-7/standalone.png[]
...
image::acm-multicluster-2-7/node_0.png[]
...
image::acm-multicluster-2-7/install-config.png[]
...
image::acm-multicluster-2-7/env_labels.png[]

[start=1]
1. Navigate to *Applications*
2. Click *Create application, select Subscription*. 

image::acm-multicluster-2-7/create_sub_app.png[]
...
image::acm-multicluster-2-7/label_sub.png[]
...
image::acm-multicluster-2-7/book_topology.png[]
...
image::acm-multicluster-2-7/book_website.png[]
...
image::acm-multicluster-2-7/inform_results.png[]
...
image::acm-multicluster-2-7/enforce_results.png[]
