...
image::images/acm-multicluster-2-7/RHACM_all_cluster.png[]
...
image::images/acm-multicluster-2-7/credentials.png[]

image::images/acm-multicluster-2-7/add_cred.png[]

=== You will need to provide connection details:

* Cloud Provider Credentials: Choose *Amazon Web Services* +

image::images/acm-multicluster-2-7/aws_cred.png[]

image::images/acm-multicluster-2-7/aws_cred2.png[]
...
image::images/acm-multicluster-2-7/cred_basicinfo.png[]
...
image::images/acm-multicluster-2-7/screen2.png[]
...
image::images/acm-multicluster-2-7/pull_secret.png[]
...
image::images/acm-multicluster-2-7/screen4.png[]
...
image::images/acm-multicluster-2-7/create_cluster.png[]


[start=3]
3. Select *Amazon Web services*

image::images/acm-multicluster-2-7/aws_cluster.png[]

[start=4]
4. Select *Standalone*

image::images/acm-multicluster-2-7/standalone.png[]
...
image::images/acm-multicluster-2-7/node_0.png[]
...
image::images/acm-multicluster-2-7/install-config.png[]
...
image::images/acm-multicluster-2-7/env_labels.png[]

[start=1]
1. Navigate to *Applications*
2. Click *Create application, select Subscription*. 

image::images/acm-multicluster-2-7/create_sub_app.png[]
...
image::images/acm-multicluster-2-7/label_sub.png[]
...
image::images/acm-multicluster-2-7/book_topology.png[]
...
image::images/acm-multicluster-2-7/book_website.png[]
...
image::images/acm-multicluster-2-7/inform_results.png[]
...
image::images/acm-multicluster-2-7/enforce_results.png[]
