...
image::acm-multicluster-2-7/RHACM_all_cluster.png[width=650]
...
image::acm-multicluster-2-7/credentials.png[width=600]

image::acm-multicluster-2-7/add_cred.png[width=700]

=== You will need to provide connection details:

* Cloud Provider Credentials: Choose *Amazon Web Services* +

image::acm-multicluster-2-7/aws_cred.png[width=800]

image::acm-multicluster-2-7/aws_cred2.png[width=800]
...
image::acm-multicluster-2-7/cred_basicinfo.png[width=800]
...
image::acm-multicluster-2-7/screen2.png[width=800]
...
image::acm-multicluster-2-7/pull_secret.png[width=650]
...
image::acm-multicluster-2-7/screen4.png[width=700]
...
image::acm-multicluster-2-7/create_cluster.png[width=800]


[start=3]
3. Select *Amazon Web services*

image::acm-multicluster-2-7/aws_cluster.png[width=800]

[start=4]
4. Select *Standalone*

image::acm-multicluster-2-7/standalone.png[width=800]
...
image::acm-multicluster-2-7/node_0.png[width=700]
...
image::acm-multicluster-2-7/install-config.png[width=500]
...
image::acm-multicluster-2-7/env_labels.png[width=800]

[start=1]
1. Navigate to *Applications*
2. Click *Create application, select Subscription*. 

image::acm-multicluster-2-7/create_sub_app.png[width=800]
...
image::acm-multicluster-2-7/label_sub.png[width=650]
...
image::acm-multicluster-2-7/book_topology.png[width=800]
...
image::acm-multicluster-2-7/book_website.png[width=700]
...
image::acm-multicluster-2-7/inform_results.png[width=700]
...
image::acm-multicluster-2-7/enforce_results.png[width=800]
