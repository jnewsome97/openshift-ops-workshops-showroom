...
image::images/acs-devsecops-4-1/tekton-1.png[]
...
image::images/acs-devsecops-4-1/ci-1.gif[]
...
* You will need to add the image you wish to scan (quay.io/mfoster/log4shell:latest). In this case, we want to look at the image we know has the log4shell vulnerability.

* Click start and ensure that the pipeline is in its running phase.

image::images/acs-devsecops-4-1/pipeline-1.gif[]
...
image::images/acs-devsecops-4-1/pipeline-2.png[]

image::images/acs-devsecops-4-1/pipeline-3.png[]
...
image::images/acs-devsecops-4-1/pipeline-9.png[]
