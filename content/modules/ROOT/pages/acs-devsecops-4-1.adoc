...
image::acs-devsecops-4-1/tekton-1.png[width=65%]
...
image::acs-devsecops-4-1/pipeline-2.png[width=55%]

image::acs-devsecops-4-1/pipeline-3.png[width=55%]
...
image::acs-devsecops-4-1/pipeline-9.png[width=55%]
