...
image::acs-devsecops-4-1/tekton-1.png[]
...
image::acs-devsecops-4-1/pipeline-2.png[]

image::acs-devsecops-4-1/pipeline-3.png[]
...
image::acs-devsecops-4-1/pipeline-9.png[]
