...
image::acs-devsecops-4-1/tekton-1.png[width=500]
...
image::acs-devsecops-4-1/ci-1.gif[]
...
image::acs-devsecops-4-1/pipeline-1.gif[]
...
image::acs-devsecops-4-1/pipeline-2.png[width=600]

image::acs-devsecops-4-1/pipeline-3.png[width=600]
...
image::acs-devsecops-4-1/pipeline-9.png[width=600]
