...
[source,bash,role="execute"]
----
oc get route backstage-developer-hub -n rhdh -o jsonpath='https://{.spec.host}'
----

Output:

----
https://backstage-developer-hub-rhdh.apps.cluster-GUID.example.com
----
...
[source,bash,role="execute"]
----
oc get configmap -n rhdh | grep rbac
----
