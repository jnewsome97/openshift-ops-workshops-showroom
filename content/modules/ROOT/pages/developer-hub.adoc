...
**Red Hat Developer Hub (RHDH)** is an internal developer portal that lets developers provision their own apps—using templates YOU define.
...
Scroll down on the Home page. You'll now see an **Explore Templates** section with template cards:

* **Create Backend Plugin Template**
* **Create a Python application in GitLab with a CI pipeline**
* **Create a tekton CI Pipeline**
* **Create a .NET Frontend application in Azure DevOps**

**This is what developers see:** A menu of pre-approved application templates.

Click on any template (e.g., **Create Backend Plugin Template**). You'll see the self-service wizard with three steps:

**Step 1: Provide some information**

* Plugin ID, Description, Owner
...
* Repository name
* Option to create new repo or submit PR to existing

**Step 3: Review**

* Confirms all selections before creating

The developer clicks through, fills in a few fields, and the template creates everything—repo, code scaffold, CI pipeline—automatically.

**The key point:** Developers don't submit tickets to you. They self-serve. Everything they create follows your standards because it came from a template you approved.
