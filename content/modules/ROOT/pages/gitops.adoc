...
image::gitops/argocd-sync-flow.png[width=75%]
...
image::gitops/gitops-tile-new.png[width=75%]
...
+ 
image::gitops/9-tiles.png[width=70%]
+
...
+
image::gitops/connection-private-argo.png[width=75%]
[start=3]
...
image::gitops/authorize-access-argo.png[width=70%]
...
image::gitops/argoaddapp2.png[width=70%]
...
image::gitops/pipelines-gitops2new.png[width=75%]
...
image::gitops/pipelines-openshift-new.png[width=70%]
...
image::gitops/banner_yamlfile.png[width=70%]

[start=3]
3. Click `Create`

image::gitops/argo_appsdeployednew.png[width=70%]

[start=4]
4. If you look back at your OpenShift Console you should now see your new banner on the top of the screen!

image::gitops/banner.png[width=70%]
...
image::gitops/consolenotification2.png[width=75%]
...
image::gitops/patch.png[width=75%]
...
image::gitops/changedtext.png[width=75%]
...
image::gitops/oops.png[width=70%]
...
image::gitops/selectfordiffnew.png[width=70%]

image::gitops/outofsync.png[width=70%]
...
image::gitops/diff.png[width=75%]

image::gitops/diff2.png[width=70%]
