...
image::gitops/argocd-sync-flow.png[]
...
image::gitops/gitops-tile-new.png[]
...
+
image::gitops/connection-private-argo.png[width=40%]
[start=3]
...
image::gitops/authorize-access-argo.png[]
...
image::gitops/pipelines-gitops2new.png[]
...
image::gitops/pipelines-openshift-new.png[]
...
image::gitops/consolenotification2.png[]
...
image::gitops/selectfordiffnew.png[]

image::gitops/outofsync.png[]
...
image::gitops/diff.png[]

image::gitops/diff2.png[]
