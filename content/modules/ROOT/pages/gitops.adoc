...
image::gitops/argocd-sync-flow.png[width=650]
...
image::gitops/gitops-tile-new.png[width=500]
...
+ 
image::gitops/9-tiles.png[width=600]
+
...
+
image::gitops/connection-private-argo.png[width=500]
[start=3]
3. You can now `login` into the Argo CD UI by selecting `Log in Via OpenShift`.
+
image::gitops/login-openshift.png[]
...
image::gitops/authorize-access-argo.png[width=600]
...
image::gitops/argoaddapp2.png[width=600]

image::gitops/editasyaml.png[]
...
image::gitops/pipelines-gitops2new.png[width=500]
...
image::gitops/pipelines-openshift-new.png[width=800]
...
image::gitops/banner_yamlfile.png[width=800]

[start=3]
3. Click `Create`

image::gitops/argo_appsdeployednew.png[width=800]

[start=4]
4. If you look back at your OpenShift Console you should now see your new banner on the top of the screen!

image::gitops/banner.png[width=600]
...
image::gitops/patch.png[width=650]
...
image::gitops/changedtext.png[width=650]
...
image::gitops/oops.png[width=800]
...
image::gitops/selectfordiffnew.png[width=800]

image::gitops/outofsync.png[width=800]
...
image::gitops/diff.png[width=500]

image::gitops/diff2.png[width=800]
