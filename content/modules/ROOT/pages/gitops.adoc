...
image::gitops/argocd-sync-flow.png[width=50%]
...
image::gitops/gitops-tile-new.png[width=60%]
...
+ 
image::gitops/9-tiles.png[width=55%]
+
...
+
image::gitops/connection-private-argo.png[width=60%]
[start=3]
...
image::gitops/authorize-access-argo.png[width=55%]
...
image::gitops/argoaddapp2.png[width=55%]
...
image::gitops/pipelines-gitops2new.png[width=65%]
...
image::gitops/pipelines-openshift-new.png[width=40%]
...
image::gitops/banner_yamlfile.png[width=40%]

[start=3]
3. Click `Create`

image::gitops/argo_appsdeployednew.png[width=40%]

[start=4]
4. If you look back at your OpenShift Console you should now see your new banner on the top of the screen!

image::gitops/banner.png[width=55%]
...
image::gitops/consolenotification2.png[width=45%]
...
image::gitops/patch.png[width=50%]
...
image::gitops/changedtext.png[width=50%]
...
image::gitops/oops.png[width=40%]
...
image::gitops/selectfordiffnew.png[width=40%]

image::gitops/outofsync.png[width=40%]
...
image::gitops/diff.png[width=60%]

image::gitops/diff2.png[width=40%]
