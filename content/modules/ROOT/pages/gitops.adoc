...
image::images/gitops/argocd-sync-flow.png[]
...
image::images/gitops/gitops-tile-new.png[]
...
+ 
image::images/gitops/9-tiles.png[]
+
...
+
image::images/gitops/connection-private-argo.png[]
[start=3]
3. You can now `login` into the Argo CD UI by selecting `Log in Via OpenShift`.
+
image::images/gitops/login-openshift.png[]
...
image::images/gitops/authorize-access-argo.png[]
...
image::images/gitops/newappbutton.png[]
...
image::images/gitops/argoaddapp2.png[]

image::images/gitops/editasyaml.png[]
...
image::images/gitops/pipelines-gitops2new.png[]
...
image::images/gitops/pipelines-openshift-new.png[]
...
image::images/gitops/banner_yamlfile.png[]

[start=3]
3. Click `Create`

image::images/gitops/argo_appsdeployednew.png[]

[start=4]
4. If you look back at your OpenShift Console you should now see your new banner on the top of the screen!

image::images/gitops/banner.png[]
...
image::images/gitops/changedtext.png[]
...
image::images/gitops/selectfordiffnew.png[]

image::images/gitops/outofsync.png[]
...
image::images/gitops/diff.png[]

image::images/gitops/diff2.png[]
