...
[source,bash,role="execute"]
----
oc apply -f https://raw.githubusercontent.com/jnewsome97/openshift-days-ops-track-showroom/main/manifests/debugging/broken-apps.yaml
----
...
[source,bash,role="execute"]
----
oc apply -f https://raw.githubusercontent.com/jnewsome97/openshift-days-ops-track-showroom/main/manifests/debugging/working-app.yaml
----
