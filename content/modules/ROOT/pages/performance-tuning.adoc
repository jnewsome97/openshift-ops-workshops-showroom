...
[source,bash,role="execute"]
----
oc apply -f https://raw.githubusercontent.com/jnewsome97/openshift-days-ops-track-showroom/main/manifests/performance/memory-hog.yaml
----
...
[source,bash,role="execute"]
----
oc apply -f https://raw.githubusercontent.com/jnewsome97/openshift-days-ops-track-showroom/main/manifests/performance/vpa-operator.yaml
----
...
[source,bash,role="execute"]
----
oc apply -f https://raw.githubusercontent.com/jnewsome97/openshift-days-ops-track-showroom/main/manifests/performance/vpa-memory-hog.yaml
----
...
[source,bash,role="execute"]
----
oc apply -f https://raw.githubusercontent.com/jnewsome97/openshift-days-ops-track-showroom/main/manifests/performance/demo-app.yaml
----
...
Continue to **Virtualization** to learn about running VMs on OpenShift.
