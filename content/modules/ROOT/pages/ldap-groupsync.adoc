...
Result: `No resources found.` (Not in any project-specific groups)
...
**Next Module:** You'll learn application management basics including deployments, services, and routes.
