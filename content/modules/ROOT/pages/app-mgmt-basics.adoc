...
.OpenShift Pods
image::app-mgmt-basics/openshift_pod_new.png[width=70%]
...
### Services
.OpenShift Service
image::app-mgmt-basics/openshift_service_new.png[width=70%]
...
### Background: Routes
.OpenShift Route
image::app-mgmt-basics/openshift_route_new.png[width=70%]
...
image::app-mgmt-basics/mapit-app-route.png[width=70%]
