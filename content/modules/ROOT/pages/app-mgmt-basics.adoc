...
### Services
.OpenShift Service
image::app-mgmt-basics/openshift_service_new.png[width=600]
...
### Background: Routes
.OpenShift Route
image::app-mgmt-basics/openshift_route_new.png[width=600]
...
image::app-mgmt-basics/mapit-app-route.png[width=800]
