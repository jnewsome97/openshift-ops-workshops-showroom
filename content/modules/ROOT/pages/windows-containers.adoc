...
image::wmcodiagram.png[wmco diagram]
...
.OperatorHub
image::operatorhub-menu.png[OperatorHub Menu]
...
.WMCO Operator
image::wmco-card.png[WMCO Install Card]
...
image::mixed-windows-and-linux-workloads.png[netcandystore diagram]
...
image::ncs.png[netcandy store page]
