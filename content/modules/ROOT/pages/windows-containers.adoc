...
image::windows-containers/wmcodiagram.png[wmco diagram,width=50%]
...
.OperatorHub
image::windows-containers/operatorhub-menu.png[OperatorHub Menu,width=55%]
...
.WMCO Operator
image::windows-containers/wmco-card.png[WMCO Install Card,width=65%]

On the overview page, select *Install*.

.WMCO Operator Overview
image::windows-containers/install-overview-updated-2025.png[WMCO Overview,width=60%]
...
image::windows-containers/wmco-install-operator-overivew-page-updated-2025.png[WMCO Install Overview,width=40%]

The "Installing Operator" status page will come up.

.WMCO Install Operator status page
image::windows-containers/installing-the-wmco-status-operator-updated-2025.png[WMCO Installing,width=60%]

When the screen says "ready for use", the WMCO Operator is successfully installed.

.WMCO Install Operator status page
image::windows-containers/wmco-ready-for-use-updated-2025.png[WMCO Installing,width=60%]
...
[source,bash,role="execute",subs="attributes+"]
----
oc get machineset.machine.openshift.io -n openshift-machine-api -l machine.openshift.io/os-id=Windows
----
...
[source,bash,role="execute",subs="attributes+"]
----
oc get machineset.machine.openshift.io -l machine.openshift.io/os-id=Windows -n openshift-machine-api
----
...
[source,bash,role="execute",subs="attributes+"]
----
oc scale machineset.machine.openshift.io -l machine.openshift.io/os-id=Windows -n openshift-machine-api --replicas=2
----
...
[source,bash,role="execute",subs="attributes+"]
----
oc scale machineset.machine.openshift.io -l machine.openshift.io/os-id=Windows -n openshift-machine-api --replicas=1
----
...
image::windows-containers/ncs.png[netcandy store page,width=45%]
