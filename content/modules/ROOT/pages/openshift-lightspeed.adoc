...
You can also verify in the console by navigating to *Operators* → *Installed Operators* and switching to the `openshift-lightspeed` namespace:
...
Once the OLSConfig is ready, refresh your OpenShift console. The Lightspeed chat button in the bottom right corner will now be functional:
