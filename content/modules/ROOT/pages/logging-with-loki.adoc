...
image::logging-with-loki/local-cluster.png[]
...
image::logging-with-loki/installedloggingoperators2.png[]
...
image::logging-with-loki/lokistack-s3.png[]
...
image::logging-with-loki/creatinglokistackcr.png[]
...
image::logging-with-loki/LokiStack.png[]
...
image::logging-with-loki/settingcollector.png[]
...
image::logging-with-loki/uipluginenabled.png[]
...
image::logging-with-loki/Loki_refresh.png[]
...
image::logging-with-loki/appinfraaudit.png[width=40%]
...
image::logging-with-loki/filterlogs.png[width=40%]
...
image::logging-with-loki/severity.png[width=40%]
...
image::logging-with-loki/histogram.png[]
