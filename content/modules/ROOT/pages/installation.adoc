...
image::installation/openshift_master_4_responsibilities_new.png[width=40%]
...
You can access the OpenShift web console using the link provided on your lab credentials page, or by using the following link:
...
image::installation/cluster-switch.png[]
